 ...
 * This file contains the CarShowArrayListImplTest class which is responsible for
 * testing methods added to the CarShowArrayListImpl class.
 */
...
public class CarShowArrayListImplTest {
  ...
  /**
   * CarShow objects added to ArrayList
  ...
  public void isPresentObjectTest() throws Exception {
    ...
    this.impl.emptyList();
    addAllCarShows();
    CarShow show4 = new CarShow();//dummy object not stored in ArrayList
