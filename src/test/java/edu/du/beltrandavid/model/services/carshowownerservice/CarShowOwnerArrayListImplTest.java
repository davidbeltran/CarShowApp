 ...
 * This file contains the CarShowOwnerArrayListImplTest class which is responsible for
 * testing methods added to the CarShowOwnerArrayListImpl class.
 */
...
public class CarShowOwnerArrayListImplTest {
  ...
  /**
   * CarShowOwner objects added to ArrayList
  ...
  public void removeTest() throws Exception {
    ...
    ArrayList<CarShowOwner> al = createList();
    //Checks "happy path"
    assertEquals(3, al.size());//ArrayList size before remove()
    this.impl.remove(this.cso1);
    al = createList();
    assertEquals(2, al.size());//ArrayList size after remove()
  ...
  public void isPresentTwoStringTest() throws Exception {
    ...
    //stored object in ArrayList
    assertEquals(true, this.impl.isPresent("cs1", "909"));
    
    //Checks negative path String arguments do not locate an object not stored in ArrayList
  ...
  public void isPresentObjectTest() throws Exception {
    ...
    this.impl.emptyList();  
    addAllCarShowOwners();
    CarShowOwner cso4 = new CarShowOwner();//dummy object not stored in ArrayList
