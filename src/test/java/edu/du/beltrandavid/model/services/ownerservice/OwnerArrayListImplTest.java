 ...
 * This file contains the OwnerArrayListImplTest class which is responsible for
 * testing methods added to the OwnerArrayListImpl class.
 */
...
public class OwnerArrayListImplTest {
  ...
  public void createOwners(){
    ...
    impl.setServiceProperties("servicepropertiesarraylisttest.txt");
  }
  
  /**
   * Owner objects added to ArrayList
  ...
  public void isPresentObjectTest() throws Exception {
    ...
    this.impl.emptyList();
    addAllOwners();
    Owner owner4 = new Owner();//dummy object not stored in ArrayList
